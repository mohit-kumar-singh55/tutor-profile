...
function AboutTutor() {
  return (
    <div className="snap-fullPage mx-auto flex items-center justify-evenly flex-col">
      ...
      {/* mainContainer */}
      <main className='flex items-center justify-center flex-wrap-reverse gap-5'>
        <Video />
        <Description />
      </main>
    </div>
...
function Video(props) {
  ...
  return (
    <div className=" mx-auto mb-6 flex w-full flex-col gap-4 sm:w-[467px] md:w-auto ">
      <div className="  md:white-linear-gradient h-[161px] rounded-lg bg-gradient-to-r  from-[#FD4E6D] to-[#FDA02F]  p-1.5 sm:h-[302px] sm:w-[467px] md:rounded-xl  ">
