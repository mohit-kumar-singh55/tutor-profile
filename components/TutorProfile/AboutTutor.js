...
function AboutTutor() {
  ...
  function toggleSlides1() {
    setSlides({ ...false, slide1: true })
  }

  function toggleSlides2() {
    setSlides({ ...false, slide2: true })
  }

  function toggleSlides3() {
    setSlides({ ...false, slide3: true })
  }

  return (
    <div className="snap-fullPage mx-auto mt-36  mb-16  flex  max-w-sm   items-center justify-center    md:mx-auto md:mt-auto md:mb-auto md:h-screen ">
  ...
  return (
    <div className={css}>
      <p className="slide-para-style mb-2 text-sm md:mb-[40px]">
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum amet, magni vero non tempora accusantium eligendi veritatis quo! Similique maiores, vel in, veniam, ipsa nesciunt quasi et quo ipsum assumenda laudantium ex quos eveniet possimus sint suscipit saepe dolorem recusandae? Temporibus sit architecto debitis consequatur eligendi maiores! Doloribus, impedit consequuntur!
      </p>
      ...
      <div className=" flex flex-col gap-[1rem] font-poppins text-[#858585]">
        ...
        <div>
          ...
          <p className="slide-para-style">
            {/* {user_data.introduction} */}
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus soluta quas similique cum qui natus magnam nisi, earum deleniti impedit tempore consequuntur odit eos aut corrupti laboriosam iure reiciendis sit sed atque veniam vitae. Harum, doloribus similique perferendis ratione explicabo sit. Placeat libero non, dicta quas illum reiciendis repellat sunt?
          </p>
        </div>
      </div>
    </div>
...
function Slide3({ css, user_data }) {
  return (
    <di className={css}>
      <p className="slide-para-style mb-2 text-sm md:mb-[40px]">
        {/* {user_data.introduction} */}
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi nostrum eligendi suscipit animi eaque maxime debitis recusandae fuga earum praesentium.
      </p>
