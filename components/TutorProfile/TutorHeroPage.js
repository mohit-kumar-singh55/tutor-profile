...
const ProfileChip = () => {
  return (
    <div className='flex items-center justify-between absolute bottom-[100px] left-[60px] sm:w-[300px] sm:-h-[60px] w-[216px] h-[40px] bg-[#FFFFFF] rounded-full px-4 py-2 font-roboto'>
      <div>
